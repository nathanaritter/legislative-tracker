...
from config import TARGET_STATES, BILL_STATUSES, CRE_SUBJECTS
...
def build_sidebar():
    ...
    return html.Div(
        [
            ...
            dcc.Dropdown(
                id="state-filter",
                options=[{"label": s, "value": s} for s in TARGET_STATES],
                value=[],
                multi=True,
            ...
            dcc.Dropdown(
                ...
                value=[],
                multi=True,
                placeholder="All counties in selected states",
                className="dash-dropdown filter-row",
            ),
            ...
            dcc.Dropdown(
                ...
                value=[],
                multi=True,
                placeholder="All cities in selected counties",
                className="dash-dropdown filter-row",
            ),
